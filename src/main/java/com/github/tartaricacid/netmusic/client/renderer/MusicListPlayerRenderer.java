...
public class MusicListPlayerRenderer implements BlockEntityRenderer<TileEntityMusicListPlayer> {
    public static ModelMusicPlayer<?> MODEL;
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(NetMusic.MOD_ID, "textures/block/music_list_player.png");
    public static MusicListPlayerRenderer instance;

    private final Font font;
    private final BlockEntityRenderDispatcher dispatcher;

    public MusicListPlayerRenderer(BlockEntityRendererProvider.Context context) {
    ...
    @Override
    public void render(TileEntityMusicListPlayer te, float pPartialTicks, PoseStack matrixStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
        Direction facing = te.getBlockState().getValue(HorizontalDirectionalBlock.FACING);
        ItemStack cd = te.getPlayerInv().getStackInSlot(te.getCurrentSlot());
    ...
    private void renderLyric(TileEntityMusicListPlayer te, PoseStack poseStack, MultiBufferSource bufferIn, int combinedLightIn) {
    ...
    @Override
    public boolean shouldRenderOffScreen(TileEntityMusicListPlayer musicPlayer) {
        return true;
    }

    @Override
    public AABB getRenderBoundingBox(TileEntityMusicListPlayer blockEntity) {
