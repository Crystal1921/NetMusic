...
public class InitContainer {
    ...
    public static final Supplier<MenuType<MusicListPlayerMenu>> MUSIC_LIST_PLAYER_CONTAINER = CONTAINER_TYPE.register("music_list_player", () -> MusicListPlayerMenu.TYPE);
}
